...
def main():
    ...
    wl, flux, ivar = bases.readdata('../../data/J1030_stack1dnew.fits', wlmin=32000, wlmax=39500)
    ...
    from_previous = True
    savefile = '../saves/J1030_mcmc_samples_step1_twocomp.pickle' 

    if from_previous:
        samples = pickle.load(open('../saves/J1030_mcmc_samples_step2_final.pickle', 'rb'))
        ...
        savefile = '../saves/J1030_mcmc_samples_step2_final.pickle' 
